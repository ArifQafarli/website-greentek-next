  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      <Container className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Title */}
        <h2
          className="text-3xl sm:text-4xl lg:text-5xl font-normal font-poppins leading-snug text-[#0C0D10] text-left"
          dangerouslySetInnerHTML={{ __html: t("mission_title") }}
        />

        {/* Content */}
        <div className="mt-12 sm:mt-14 lg:mt-16 grid gap-10 lg:grid-cols-4 items-center">
          {/* Left Image */}
          <div className=" justify-center lg:justify-start lg:flex hidden ">
            <Image
